...
const SERVICES = [
  {
    ...
    icon: Building2,
    image: '/images/HomePage/Corporate Offices.png',
  ...
  },
  {
    ...
    icon: Factory,
    image: '/images/HomePage/Industrial & Manufacturing.png',
  ...
  },
  {
    ...
    icon: ShoppingBag,
    image: '/images/HomePage/Retail & Shopping centers.png',
  ...
  },
  {
    ...
    icon: Stethoscope,
    image: '/images/HomePage/Healthcare & Medical.png',
  ...
  },
  {
    ...
    icon: GraduationCap,
    image: '/images/HomePage/Educational Facilities.png',
  ...
  },
  {
    ...
    icon: Utensils,
    image: '/images/HomePage/Hospitality & Venues.png',
  ...
  },
  {
    ...
    icon: Home,
    image: '/images/HomePage/House Cleaning.png',
  ...
  },
  {
    ...
    icon: Key,
    image: '/images/HomePage/End of lease cleaning.png',
  ...
  },
  {
    ...
    icon: Wind,
    image: '/images/HomePage/Carpet & Upholstery Steam.png',
  ...
  },
  {
    ...
    icon: Maximize,
    image: '/images/HomePage/Window Cleaning.png',
  ...
  },
  {
    ...
    icon: Hammer,
    image: '/images/HomePage/Post-Construction.png',
  ...
  },
  {
    ...
    icon: CalendarCheck,
    image: '/images/HomePage/Airbnb & Short-Term Rental.png',
